     ...
     async function sendMessage(){ // faire l'appel du fonction sendMessage() quand l'utilisateur rempli le champ de message, et clique sur le bouton.
 ...
 async function getSay(){
                                               // pour notre URL, on récupere les valeurs du:
    ...
    let say = localStorage.getItem("say");     // say (le message encodé)
        ...
        method: 'GET',
            ...
            try {
                ...
                localStorage.removeItem('say'); // effacer la valeur 'say' du localStorage, pour eviter le renvoyer en cas où
